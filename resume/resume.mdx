...
* Planned, executed, and delivered multiple technical writing projects, including: 
    ...
    * Optimized documentation and the documentation site for AI and LLM consumption, including adding a custom `llm.txt` file and auditing site hierarchy
    * Refreshed and repurposed outdated style guide to standardize documentation.
    * Authored full documentation refresh, including updating information architecture, restructuring existing articles, and filling knowledge gaps, for owned product suite 
    * Automated content updates based off of GitHub releases across multiple repositories
    * Leveraged AI skills and tools to automate regular, repeatable tasks
    * Led the effort to create an agentic documentation testing tool to detect stale documentation, reducing the need for manual audits
...
Agile methodologies, Markdown, MDX, YAML, OpenAPI Specification, CSS, HTML, Python, R, reStructuredText, XML, docs-as-code, CI/CD, project management, API documentation, how-to articles

## Tools

Jira, Confluence, Git, GitHub, Guru, Document360, Zendesk, Docusaurus, Sphinx, ReadMe, Fern, Mintlify, Visual Studio Code, Sublime Text, Brackets, Claude, Glean, Intercom, Announcekit, Dovetail, Pendo, InVision, Snagit, Figma, Canva, Adobe Photoshop, Adobe InDesign, Clari Copilot, Loom, Slack, Zoom, Google Suite
