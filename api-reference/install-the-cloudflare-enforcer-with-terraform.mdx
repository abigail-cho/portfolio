...
<Tree>
    <Tree.Folder name="terraform" defaultOpen>
        ...
        <Tree.Folder name="worker" defaultOpen>
            <File name="package.json" comment="Depends on @humansecurity/cloudflare-enforcer" />
            <File name="wrangler.toml" comment="Wrangler build config (main = src/index.ts)" highlighted />
            <File name="tsconfig.json" comment="TypeScript config with resolveJsonModule: true" />
            <File name=".gitignore" comment="Excludes node_modules/, dist/, src/config.json" />
            <Folder name="src" defaultOpen>
                <File name="index.ts" comment="Worker entrypoint: enforce → fetch → postEnforce" highlighted />
                <File name="humansecurity.ts" comment="Re-exports @humansecurity/cloudflare-enforcer" highlighted />
            </Folder>
        </Folder>
        <Folder name="examples">
            <Folder name="basic">
                <File name="main.tf" comment="Minimal working example calling the module" />
            </Folder>
        </Folder>
    </Folder>
</Files>

<Accordion title="Detailed file information">
| File | Purpose |
|---|---|
