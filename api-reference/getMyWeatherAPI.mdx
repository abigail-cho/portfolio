...
description: 'Sample end-to-end API documentation'
---

<Accordion title="Why I included this sample">
...
I included this sample because it showcases end-to-end API documentation. This was a personal project.
</Accordion>
...
GetMyWeather will return an HTML package on a successful call. Below is a sample response.
